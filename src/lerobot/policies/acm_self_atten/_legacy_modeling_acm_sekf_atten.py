...
from lerobot.policies.acm_self_atten._legacy_configuration_acm_self_atten import ACMSelfConfig
from lerobot.policies.pretrained import PreTrainedPolicy
from lerobot.utils.constants import ACTION, OBS_ENV_STATE, OBS_IMAGES, OBS_STATE

class ACMSelfPolicy(PreTrainedPolicy):
    config_class = ACMSelfConfig
    name = "acm_self_atten"

    def __init__(
        self,
        config: ACMSelfConfig,
    ):
        """
        Args:
...
class ACM(nn.Module):
    ...
    def __init__(self, config: ACMSelfConfig):
...
class ACTEncoder(nn.Module):
    ...
    def __init__(self, config: ACMSelfConfig, is_vae_encoder: bool = False):
        super().__init__()
