...
from lerobot.policies.acm_cross_atten._legacy_configuration_acm_cross_atten import ACMCrossConfig
from lerobot.policies.pretrained import PreTrainedPolicy
from lerobot.utils.constants import ACTION, OBS_ENV_STATE, OBS_IMAGES, OBS_STATE

class ACMCrossPolicy(PreTrainedPolicy):
    config_class = ACMCrossConfig
    name = "acm_cross_atten"

    def __init__(
        self,
        config: ACMCrossConfig,
    ):
        """
        Args:
...
class ACM(nn.Module):
    ...
    def __init__(self, config: ACMCrossConfig):
...
class ACTEncoder(nn.Module):
    ...
    def __init__(self, config: ACMCrossConfig, is_vae_encoder: bool = False):
        super().__init__()
